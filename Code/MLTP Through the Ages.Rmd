...
beeswarm(cpm ~ season, data = MLTP_offense_stats, pch = 16, col = rainbow(10), method = "hex",
         main = "Caps Per Minute for Offenders", xlab = "Season", ylab = "Captures Per Minute",
         )
...
beeswarm(gpm ~ season, data = MLTP_offense_stats, pch = 16, col = rainbow(10), method = "hex",
         main = "Grabs Per Minute for All Players", xlab = "Season", ylab = "Grabs Per Minute",
         )
...
#### Section G: Capture Differential

<br><br>

```{r echo = FALSE, warning = FALSE, message = FALSE}
beeswarm(success_rate ~ season, data = MLTP_filtered_stats, pch = 16, col = rainbow(10), method = "hex",
         main = "Capture Differential Per Minute for All Players", xlab = "Season", ylab = "Grabs Per Minute",
         )
